...
import PlanetIconGeo from "../../../assets/geology-neptune.png";
import PlanetIcon from "../../../assets/planet-neptune.svg";
...
export default function Surface({ planetInfo, setpath }: Props) {
  ...
  const planet = planetInfo?.[7];
  return (
    <Container>
      <div className="imgContainer">
        <img className="geology" src={PlanetIconGeo} alt="neptune" />
        <img className="img" src={PlanetIcon} alt="neptune" />
      </div>
      <h1>{planet.name}</h1>
