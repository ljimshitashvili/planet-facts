...
import PlanetIconGeo from "../../../assets/geology-mars.png";
import PlanetIcon from "../../../assets/planet-mars.svg";
...
export default function Surface({ planetInfo, setpath }: Props) {
  ...
  const planet = planetInfo?.[3];
  return (
    <Container>
      <div className="imgContainer">
        <img className="geology" src={PlanetIconGeo} alt="mars" />
        <img className="img" src={PlanetIcon} alt="mars" />
      </div>
      <h1>{planet.name}</h1>
