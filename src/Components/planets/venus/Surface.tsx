...
import PlanetIconGeo from "../../../assets/geology-venus.png";
import PlanetIcon from "../../../assets/planet-venus.svg";
...
export default function Surface({ planetInfo, setpath }: Props) {
  ...
  const planet = planetInfo?.[1];
  return (
    <Container>
      <div className="imgContainer">
        <img className="geology" src={PlanetIconGeo} alt="venus" />
        <img className="img" src={PlanetIcon} alt="venus" />
      </div>
      <h1>{planet.name}</h1>
